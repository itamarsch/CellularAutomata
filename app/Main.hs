...
import Graphics.Gloss.Interface.Pure.Game (Display (InWindow), Event (EventKey), Key (Char, MouseButton, SpecialKey), KeyState (Down), MouseButton (LeftButton), Picture (Scale), SpecialKey (KeyCtrlL, KeyEnter), play)
